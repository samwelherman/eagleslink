            ...
            <div class="box-body">
                ...
                <div class="form-group">
					...
					<div class="col-sm-2">
						<select class="form-control select2" name="page_layout" style="width:300px;" onchange="showContentInputArea(this)">
							...
							<option value="Attorney Page Layout" <?php if($page_layout=='Attorney Page Layout') {echo 'selected';} ?>>Attorney Page Layout</option>
				...
				<div class="form-group">
					...
					<div class="col-sm-9" style="padding-top:5px">
						<img src="../assets/uploads/<?php echo $banner; ?>" alt="Page Banner" style="width:200px;">
					</div>
				</div>
				<div class="form-group">
